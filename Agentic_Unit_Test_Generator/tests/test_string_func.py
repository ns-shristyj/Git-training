...
def test_reverse_string_type_confusion_raises_typeerror():
...
def test_truncate_truncates_and_appends_ellipsis():
    assert truncate("hello world", 5) == "hello..."


def test_truncate_boundary_exact_length_no_truncation():
    assert truncate("hello", 5) == "hello"


def test_truncate_boundary_off_by_one_triggers_truncation():
    assert truncate("hello!", 5) == "hello..."
